...
_EXTERNAL_GATEWAY_POLICIES: dict[str, ExternalGatewayPolicy] = {
    ...
    "owner_api_call_wallet_header": ExternalGatewayPolicy(
        id="owner_api_call_wallet_header",
        label="Owner API call (wallet header)",
        enabled=True,
        require_approval=False,
        record_cost=True,
        allow_network=True,
        auth_required=True,
        auth_header_name="x-wallet-address",
        timeout_seconds=20,
        max_retries=1,
        retry_backoff_seconds=0.5,
        rate_limit_calls=10,
    ...
    "owner_api_call_optional_wallet_header": ExternalGatewayPolicy(
        id="owner_api_call_optional_wallet_header",
        label="Owner API call optional auth (wallet header)",
        enabled=True,
        require_approval=False,
        record_cost=True,
        allow_network=True,
...
_EXTERNAL_CAPABILITY_ROUTES: dict[str, ExternalCapabilityRoute] = {
    ...
    "obolos_wallet_balance_primary": ExternalCapabilityRoute(
        ...
        allowed_export_modes=("internal",),
        gateway_contract_id="external_api_call_v1",
        gateway_policy_id="owner_api_call_wallet_header",
    ...
    # ── Obolos Listings (provider-side work discovery) ──────
    "obolos_listings_list_primary": ExternalCapabilityRoute(
        route_id="obolos_listings_list_primary",
        provider_id="obolos.tech",
        capability_id="listings_list_v1",
        label="obolos.tech work listings",
        description="GET /api/listings — browse available work listings.",
        target_kind="http_api",
        target_env_var="AGENT_OBOLOS_API_BASE_URL",
        default_target_url="https://obolos.tech/api",
        auth_token_env_var="AGENT_OBOLOS_WALLET_ADDRESS",  # noqa: S106
        ...
        allowed_export_modes=("internal",),
        gateway_contract_id="external_api_call_v1",
        gateway_policy_id="owner_api_call_optional_wallet_header",
        request_mode="obolos_listings_list_v1",
        response_mode="obolos_listings_list_v1",
        estimated_cost_usd=0.0,
        priority=10,
    ),
    "obolos_listings_detail_primary": ExternalCapabilityRoute(
        route_id="obolos_listings_detail_primary",
        provider_id="obolos.tech",
        capability_id="listings_detail_v1",
        label="obolos.tech listing detail",
        description="GET /api/listings/{id} — inspect a specific work listing.",
        target_kind="http_api",
        target_env_var="AGENT_OBOLOS_API_BASE_URL",
        default_target_url="https://obolos.tech/api",
        auth_token_env_var="AGENT_OBOLOS_WALLET_ADDRESS",  # noqa: S106
        ...
        gateway_contract_id="external_api_call_v1",
        gateway_policy_id="owner_api_call_optional_wallet_header",
        request_mode="obolos_listings_detail_v1",
        response_mode="obolos_listings_detail_v1",
        estimated_cost_usd=0.0,
        priority=10,
    ),
    "obolos_listings_bid_primary": ExternalCapabilityRoute(
        route_id="obolos_listings_bid_primary",
        provider_id="obolos.tech",
        capability_id="listings_bid_v1",
        label="obolos.tech listing bid submission",
        description="POST /api/listings/{id}/bid — submit a bid to a work listing.",
        target_kind="http_api",
        target_env_var="AGENT_OBOLOS_API_BASE_URL",
        default_target_url="https://obolos.tech/api",
        auth_token_env_var="AGENT_OBOLOS_WALLET_ADDRESS",  # noqa: S106
        ...
        gateway_contract_id="external_api_call_v1",
        gateway_policy_id="owner_api_call_wallet_header",
        request_mode="obolos_listings_bid_v1",
        response_mode="obolos_listings_bid_v1",
        estimated_cost_usd=0.0,
        priority=10,
        notes=(
            "Documented endpoint: POST /api/listings/{id}/bid",
            "Payload: {price, delivery_time, message}",
        ),
    ),
    # ── Obolos Jobs (ERC-8183 ACP) ──────
    "obolos_jobs_list_primary": ExternalCapabilityRoute(
        route_id="obolos_jobs_list_primary",
        provider_id="obolos.tech",
        capability_id="jobs_list_v1",
        label="obolos.tech jobs list",
        description="GET /api/jobs — list jobs (accepted work).",
        target_kind="http_api",
        target_env_var="AGENT_OBOLOS_API_BASE_URL",
        default_target_url="https://obolos.tech/api",
        auth_token_env_var="AGENT_OBOLOS_WALLET_ADDRESS",  # noqa: S106
        ...
        gateway_contract_id="external_api_call_v1",
        gateway_policy_id="owner_api_call_wallet_header",
        request_mode="obolos_jobs_list_v1",
        response_mode="obolos_jobs_list_v1",
        estimated_cost_usd=0.0,
        priority=10,
    ),
    "obolos_jobs_detail_primary": ExternalCapabilityRoute(
        route_id="obolos_jobs_detail_primary",
        provider_id="obolos.tech",
        capability_id="jobs_detail_v1",
        label="obolos.tech job detail",
        description="GET /api/jobs/{id} — inspect a specific job.",
        target_kind="http_api",
        target_env_var="AGENT_OBOLOS_API_BASE_URL",
        default_target_url="https://obolos.tech/api",
        auth_token_env_var="AGENT_OBOLOS_WALLET_ADDRESS",  # noqa: S106
        ...
        gateway_contract_id="external_api_call_v1",
        gateway_policy_id="owner_api_call_wallet_header",
        request_mode="obolos_jobs_detail_v1",
        response_mode="obolos_jobs_detail_v1",
        estimated_cost_usd=0.0,
        priority=10,
    ),
    "obolos_jobs_submit_primary": ExternalCapabilityRoute(
        route_id="obolos_jobs_submit_primary",
        provider_id="obolos.tech",
        capability_id="jobs_submit_v1",
        label="obolos.tech job work submission",
        description="POST /api/jobs/{id}/submit — submit completed work for a job.",
        target_kind="http_api",
        target_env_var="AGENT_OBOLOS_API_BASE_URL",
        default_target_url="https://obolos.tech/api",
        auth_token_env_var="AGENT_OBOLOS_WALLET_ADDRESS",  # noqa: S106
        ...
        gateway_contract_id="external_api_call_v1",
        gateway_policy_id="owner_api_call_wallet_header",
        request_mode="obolos_jobs_submit_v1",
        response_mode="obolos_jobs_submit_v1",
        estimated_cost_usd=0.0,
        priority=10,
        notes=(
